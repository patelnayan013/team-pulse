...
type Role = 'lead' | 'qa' | 'dev'

const roles: { value: Role; label: string; description: string }[] = [
  { value: 'lead', label: 'Team Lead', description: 'Manage team, view reports & briefings' },
  { value: 'qa', label: 'QA Engineer', description: 'Review tasks, manage QA queue' },
  { value: 'dev', label: 'Developer', description: 'Submit check-ins, track tasks' },
]
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>
            Get started with TeamPulse today
          </CardDescription>
        </CardHeader>
